        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-3 gap-2 sm:gap-4 md:gap-6 lg:gap-8 text-center text-white">
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-sm sm:text-lg md:text-xl lg:text-2xl font-bold">100+</h3>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-sm sm:text-lg md:text-xl lg:text-2xl font-bold">20+</h3>
